<template>
    <div class="check_icon no_highlights">
        <button class="btn-circler" style="box-shadow: none" @click="openPopup" :style="item.checked === false && 'transform: rotate(180deg)'">
        ...
        <transition name="fade">
            <div class="popup" v-show="showPopup">
                <button class="btn-circler" @click="handleCheckOrUncheck(true)" :disabled="state.acline">
