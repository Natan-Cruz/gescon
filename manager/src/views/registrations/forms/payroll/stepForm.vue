<template>
    <div class="container-step-form">
        <div class="content-step-form">
            <div class="item" @click="$emit('select-item', 'step_01')" >
                <span class="circle">1</span>
                <span class="text">Funcionários</span>            
            </div>
            <div class="item" @click="$emit('select-item', 'step_02')" >
                <span class="circle">2</span>
                <span class="text">Definir valores</span>            
            </div>
            <div class="item" @click="$emit('select-item', 'step_03')" >
                <span class="circle">3</span>
                <span class="text">Confimar valores</span>            
            </div>
...
<style lang="less" scoped>
    ...
    .content-step-form{
        ...
        display: grid;
        grid-template-columns: repeat(3, minmax(95px, 33%));
