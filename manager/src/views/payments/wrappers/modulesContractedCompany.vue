<template>
    <div class="wrapper">
        <div class="title">Módulos gerais contratados</div>
        <ul class="list-modules">
            <item label="Financeiro" :selected="activeModule('financial')">
...
export default {
    ...
    setup(props){
        function activeModule(moduleName){
            return props.modules.findIndex( mName => mName === moduleName ) > -1
        }
