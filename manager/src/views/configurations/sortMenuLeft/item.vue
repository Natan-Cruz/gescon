<template>
    <li class="item" 
		...
		@drop.stop.prevent="handleDragDrop" :style="item.style">
        <button class="drag-indicator" title="Arrastar item">
...
export default {
    ...
    setup(props, { emit }){
        function handleDragStart(evt){
            ...
            emit('event-drag-start', props.item)
        }
        function handleDragEnter(evt){
            evt.dataTransfer.dropEffect = "copy";
            emit('event-drag-enter', props.item)
        }
        ...
        function handleDragDrop(evt){
         ...
         function defineCoordenates(evt){
            ...
            return { item: props.item, position: position }
        }
